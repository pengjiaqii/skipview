...
public class AppListActivity extends Activity{
    ...
    class AppListAdapter extends RecyclerView.Adapter<AppListAdapter.MyViewHolder>{
        ...
        public void onBindViewHolder(MyViewHolder holder, int position){
            ...
            Log.i("launcher3j06", "---positionPackageName---"+positionPackageName);
            Log.i("launcher3j06", "---positionAppName---"+positionAppName);
    ...
    private Bitmap getLocalIconBitmap(String packageName, String className){
        Log.d("launcher3j06", "AppListActivity---getLocalIconBitmap---packageName--->" + packageName);
        Log.d("launcher3j06", "AppListActivity---getLocalIconBitmap---className--->" + className);
